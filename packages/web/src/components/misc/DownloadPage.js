        ...
        <ThemeProvider theme={theme}>
            <Grid container spacing={2}>
                    ...
                    >
                        ...
                        <Grid item md={10} xs={12}>
                            <Typography
                                ...
                                style={{ color: "#182945" }}
                            >
                                Monitor Landslide Risk in your Community
                            </Typography>
                        </Grid>
                        <Grid item md={1} xs={0} />
                        <Grid item md={3} xs={0} />
                        <Grid item md={6} xs={12}>
                            ...
                            >
                                With this app, Community-based enabled Dynaslope
                                Project sites can explore and operate Early
                ...
                >
                    ...
                    >
                        To know more about Early Warning System for Landslide in
                        the Philippines, follow and contact us in Facebook at{" "}
