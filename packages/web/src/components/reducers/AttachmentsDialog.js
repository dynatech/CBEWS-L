...
export default function AttachmentsDialog (props) {
    const { 
        ...
        handleDelete, handleDownload, handleClickDeleteUpload,
        ...
        >
            ...
            <DialogContent>
                <Grid container spacing={1}>
                    <Grid item xs={12}>
                        <PhotoAttachmentList imageRef={imageRef} data={attachment_list} />
                    </Grid>
                    <Grid item xs={6}>
                        <TextField
                            autoFocus
            ...
            <DialogActions>
                ...
                <Button onClick={handleClickDeleteUpload} color="secondary">Delete Current</Button>
